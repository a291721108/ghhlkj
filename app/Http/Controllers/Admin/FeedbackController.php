...
class FeedbackController extends BaseController
{
     ...
     * @description 意见反馈
     * @method post
     * @url 47.92.82.25/api/clientFeedbackAdd
     *
     ...
     * @number 1
     */
    public function clientFeedbackAdd(Request $request)
    {
        ...
        $data = FeedbackService::clientFeedbackAdd($request);
     ...
     * @description 反馈详情
     * @method post
     * @url 47.92.82.25/api/clientFeedbackList
     *
     * @header api_token 必选 string api_token放到authorization中
     *
     ...
     * @number 1
     */
    public function clientFeedbackList(Request $request)
    {
        $this->validate($request, [
            'id'      => 'required|numeric',
        ]);

        $data = FeedbackService::clientFeedbackList($request);
